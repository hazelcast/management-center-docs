...
|This script depends on Netlify env vars (`REPOSITORY_URL` and `BRANCH`) which you can encode using e.g.: `export REPOSITORY_URL=https://github.com/hazelcast/management-center-docs && export BRANCH=pull/445/head && npm run build`
