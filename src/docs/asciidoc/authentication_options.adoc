...
You can use the `update-ldap-password` command in the MC CLI tool to update the encrypted LDAP password stored in the KeyStore. Please see this command's <<update-ldap-password, description>> for details.
