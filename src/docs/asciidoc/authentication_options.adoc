...
image::ConfigureOIDC.png[OpenID Connect Configuration]
...
`/oidc/authorization-code` so you should append `/oidc/authorization-code` to the Management Center URL.
...
“http://127.0.0.1:8080/oidc/authorization-code”.
