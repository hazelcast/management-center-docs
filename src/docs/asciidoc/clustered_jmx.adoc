...
You can start Management Center application with
...
Once Management Center starts, you should see a log
...
Following is an example on how to start Management Center
...
Use the Clustered JMX interface to integrate Hazelcast Management Center
...
start Management Center as shown below.
...
you are sending to New Relic from Management Center in the **Metrics**
