...
[[map-client-near-cache-data]]**Client Near Cache Data Table** provides information about the Client Near
Caches Stats, if available, on each client that has near cache enabled for this map, as shown below.
Currently, you need to enable the statistics for clients to see them here.
...
[[cache-client-near-cache-data]]**Client Near Cache Data Table** provides information about the Client Near
Caches Stats, if available, on each client that has near cache enabled for this cache, as shown below.
Currently, you need to enable the statistics for clients to see them here.
Please refer to <<monitoring_clients.adoc#monitoring-clients, Monitoring Clients>> for details.
