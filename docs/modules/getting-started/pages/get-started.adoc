...
If you own an enterprise license you can configure the license in the compose file as following (see xref:system-properties.adoc#starting-with-a-license[`hazelcast.mc.license` property] for more details):
