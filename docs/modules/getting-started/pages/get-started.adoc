...
Go back to the cluster's dashboard and select *Storage* > *Maps* in Management Center, and then select *my_distributed_map* from the list of maps. You can now see the statistics of your map:
