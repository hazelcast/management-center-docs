...
:description: To help you find your way around Management Center, this topic explains the Top Bar and Side Bar items of the user interface.
...
NOTE: You can resize the menu by dragging the right-hand side of it.