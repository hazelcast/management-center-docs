...
* *Instance Name*. The instance name of the machine Manage Center is deployed on. Can be overridden with xref:deploy-manage:system-properties.adoc#hazelcast-mc-info-instanceName[`hazelcast.mc.info.instanceName`].
