...
* *Instance Name*. Displays the instance name of the machine MC is deployed on. In order to override the value see xref:deploy-manage:system-properties.adoc#hazelcast-mc-info-instanceName[`hazelcast.mc.info.instanceName`]
