...
NOTE: For information about what's new, see xref:{page-latest-supported-hazelcast}@hazelcast:ROOT:whats-new.adoc[What's new] in the Hazelcast Platform documentation.
