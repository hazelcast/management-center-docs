...
NOTE: For information about what is new and improved in Hazelcast Platform, see xref:{page-latest-supported-hazelcast}@hazelcast:ROOT:whats-new.adoc[What's new] in Hazelcast Platform. For information about the improvements and changes in Management Center, see the xref:release-notes:releases.adoc[Release notes]. 
