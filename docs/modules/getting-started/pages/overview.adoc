...
NOTE: For information about what is new and improved across Hazelcast products and tools, see xref:{page-latest-supported-hazelcast}@hazelcast:ROOT:whats-new.adoc[What's new]. For detailed information about Management Center changes, see the xref:release-notes:release-notes.adoc[release notes].
