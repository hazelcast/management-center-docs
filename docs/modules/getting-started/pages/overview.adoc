...
----
include::{page-latest-supported-hazelcast}@hazelcast:ROOT:example$/spring/spring-configuration/src/main/java/com/hazelcast/springconfiguration/HazelcastDataTypes.java[]
----
...
----
include::@hazelcast:ROOT:example$/spring/spring-configuration/src/main/java/com/hazelcast/springconfiguration/HazelcastDataTypes.java[]
----
