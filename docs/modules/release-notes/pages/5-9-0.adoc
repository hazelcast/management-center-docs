...
* *CVE-2024-47554 - in Management Center 5.8.0*: Resolved https://nvd.nist.gov/vuln/detail/CVE-2025-47554 to fix a vulnerability in Apache Commons IO that could excessively consume CPU resources when processing maliciously crafted input, leading to potential denial of service attacks.
