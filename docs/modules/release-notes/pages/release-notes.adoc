...
:page-aliases: release-notes:5-11-0.adoc, release-notes:5-11-1.adoc
...
* **Hardened client deserialization**: Updated Management Center’s Hazelcast Platform dependency to 5.7.1 to address known exploit paths.

* **Resolved security vulnerabilities**: Addressed high and medium severity vulnerabilities, primarily related to Jackson Core and Databind.
