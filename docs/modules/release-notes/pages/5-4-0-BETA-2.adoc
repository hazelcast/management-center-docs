...
NOTE: Hazelcast Management Center 5.3 requires Java 17 to run.
...
** Added an ability to search, filter and sort HealthCheck results. [MC-2445]
...
** Made Vien icon blue instead of red to avoid confusion. [MC-2201]
...
* Added a banner tp notify about a repartitioning in progress. [MC-2132]
