...
. From now on, you can work on Management Center as described in xref:open-source.adoc#step-3-create-a-map[creating a map] and xref:open-source.adoc#step-5-query-the-map[querying it].
