...
image:ROOT:SettingsToolBar.png[alt=Clustered Rest Provide Headers, align="center"]
...
. Select the user that you want to create token for. Only admin can create token for other users.

. Enter the label of the token that you want to create. Default value has `username_creationTime` format.
. Click *Create Token*
...
NOTE: The token will not be displayed again so make sure you note it before leaving the page or creating new one.

You can see the list of created token in table below of the page.
...
|User
|Username of the Token that is created for

|Token Label
|Label of the Token

|Action
|Action for revoking the Token
