...
|map_index_averageHitLatency
|map_index_average_hit_latency_seconds
|n/a

|map_index_averageHitSelectivity
|map_index_average_hit_selectivity_ratio
|n/a

|map_index_partitionsIndexed
|map_index_partitions_indexed_total
|n/a

|map_index_partitionUpdatesStarted
|map_index_partition_updates_started_total
|n/a

|map_index_partitionUpdatesFinished
|map_index_partition_updates_finished_total
|n/a

|map_index_notReadyQueryCount
|map_index_not_ready_queries_total
|n/a
...
|map_no_matching_index_queries_total
|n/a

|map.queryLimiterHitCount
|map_query_limiter_hits_total
|n/a

|map.store.offloaded.operations.waitingToBeProcessedCount
|map_store_offloaded_operations_waiting_to_be_processed_total
|n/a
...
|tcp.inputThread.selectorRebuildCount
|tcp_selector_rebuild_total
|thread=input

|tcp.outputThread.selectorRebuildCount
|tcp_selector_rebuild_total
|thread=output
|===
====
...
|streaming_engine_jobs_executions_completed_total
|n/a
|===
====
...
|multi_map_evictions_total
|n/a

|multiMap.expirationCount
|multi_map_expirations_total
|n/a

|multiMap.indexesSkippedQueryCount
|multi_map_indexes_skipped_queries_total
|n/a

|multiMap.noMatchingIndexQueryCount
|multi_map_no_matching_index_queries_total
|n/a

|multiMap.valuesCount
|multi_map_values_total
|n/a

|multiMap.queryLimiterHitCount
|multi_map_query_limiter_hits_total
|n/a
|===
====
...
|healthcheck_status_disabled
|healthcheck_disabled_total
|n/a
...
|license_expiration
|license_expiration_timestamp_seconds
|n/a
|===
====
