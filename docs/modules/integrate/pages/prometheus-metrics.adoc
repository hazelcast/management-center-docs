...
To change which set of metrics is exposed to Prometheus, update the `hazelcast.mc.prometheus-exporter.printers` system property:

* Original only: `hazelcast.mc.prometheus-exporter.printers=V1`
* Updated only: `hazelcast.mc.prometheus-exporter.printers=V2`
* Both (default): `hazelcast.mc.prometheus-exporter.printers=V1,V2`
