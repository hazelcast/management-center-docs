= Integrations
:description: Management Center provides integrations with Prometheus and JMX and provides a fully featured Clustered REST API for all the Clusters that it is connected to.
