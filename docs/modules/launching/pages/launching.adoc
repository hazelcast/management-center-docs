...
to have either a Management Center license, Hazelcast IMDG Pro license,
Hazelcast IMDG Enterprise or Hazelcast Jet Enterprise license. The license should be entered within the
