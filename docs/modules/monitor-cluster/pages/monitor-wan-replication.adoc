...
in Hazelcast Reference Manual for details about configuring them. Make
...
in Hazelcast Reference Manual for details about the fields and their possible values.
