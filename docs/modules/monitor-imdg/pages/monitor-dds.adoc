...
Use Clear Data button to remove all entries from the map.

image:ROOT:ClearMapData.png[Clear Map Data View]

Button opens confirmation modal. Type the map name into text field to confirm clearing out the map data.
