...
NOTE: CP subsystem management operations require enabled REST API in the IMDG cluster. See the {hz-refman}#rest-client[IMDG documentation]
...
{hz-refman}#cp-subsystem-configuration[configured CP members count].
