...
See the xref:{page-latest-supported-hazelcast}@hazelcast:management:cluster-utilities.adoc#managing-cluster-and-member-states[Hazelcast documentation] to learn more about cluster states.
