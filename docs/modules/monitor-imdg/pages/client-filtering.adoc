...
image:ROOT:ConfigureSecurity.png[alt=Default Security Provider Configuration,{half-width}, align="center"]
...
image:ROOT:ConfigureAD.png[Active Directory Configuration,{half-width}, align="center"]
...
image:ROOT:ConfigureLDAP.png[LDAP Configuration,{half-width}, align="center"]
