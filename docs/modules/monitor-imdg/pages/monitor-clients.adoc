...
chart as a separate window using the image:MaximizeChart.png[maximize]
...
{imdg-docs}#blue-green-deployment-and-disaster-recovery[Blue-Green Deployment and Disaster Recovery section]
in the Hazelcast IMDG Reference Manual for more information.
