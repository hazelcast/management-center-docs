...
NOTE: You need to create index to see this table here. See the xref:{page-latest-supported-hazelcast}@hazelcast:query:indexing-maps.adoc[Indexing Maps] for details

image:ROOT:MapIndexStatsTable.png[Map Index Stats Table]

image:ROOT:MapIndexStatsTable2.png[Map Index Stats Table-2]

To see more details about an index, click on the down arrow next to the index name.
