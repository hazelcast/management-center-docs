...
|Allows to specify the instance name visible in the xref:getting-started:user-interface.adoc#top-bar[Top Bar]. Specify explicitly blank to not display any instance name.
|
[source,bash,subs="attributes+"]
----
