...
- xref:declarative-configuration.adoc#clusters[YAML declarative configuration file] (Beta; cluster name and member addresses only, not a full client configuration file)
