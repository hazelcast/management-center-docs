...
You can also preconfigure a cluster connection before Management Center starts, using xref:connecting-to-clusters-mc-conf.adoc[`hz-mc conf`] or a xref:declarative-configuration.adoc[YAML declarative configuration file].
