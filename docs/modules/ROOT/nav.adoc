...
** xref:deploy-manage:declarative-configuration.adoc[YAML Declarative Configuration]
*** xref:deploy-manage:declarative-configuration.adoc[Overview]
*** xref:deploy-manage:declarative-configuration-apply-mode.adoc[Apply Modes]
