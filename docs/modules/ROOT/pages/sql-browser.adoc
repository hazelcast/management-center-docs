...
your cluster does not have a mapping, selecting that map will insert a sample "create mapping"
statement in the editor. If your map has a mapping, a "select" statement will be provided for you.
