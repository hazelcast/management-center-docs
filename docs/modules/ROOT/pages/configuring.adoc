...
It is in ISO-8601-based durations format that supports days, hours, minutes, seconds and its default value is `P1D`.
...
[source,bash,subs="attributes+"]
----
java -Dhazelcast.mc.hostAddress=127.0.1.1 -jar hazelcast-management-center-{page-component-version}.jar
----
