...
Management Center is distributed with an empty `bin/user-lib/` directory. You can put your libraries into this library to use them
...
----
export MC_CLASSPATH="/path/to/an/extra.jar"
mc-start.sh
----
