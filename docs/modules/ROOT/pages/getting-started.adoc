...
You can query the build information of a running Management Center instance by opening `{mc-base-url}/api/buildInfo`. It will.
return the Management Center version metadata in JSON format.
