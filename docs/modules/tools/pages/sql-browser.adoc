...
== Creating mappings via the Connector Wizard

Management Center can also help you create mappings automatically via the Connector Wizard. Click "Connector Wizard" to display it.

image:sql-wizards.png[List of connector wizards]
