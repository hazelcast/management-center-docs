...
The SQL editor supports autocompletion to suggest SQL queries for you while you type. To use autocompletion, start typing a query in the SQL editor and press kbd:[Ctrl+Space]. The SQL editor supports the following suggestions:

- Table and column names
- SQL statements such as `SELECT` and `INSERT`
- SQL functions such as `AVG` and `SUM`
