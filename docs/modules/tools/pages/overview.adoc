...
This chapter describes the usages of tools offered by Management Center:
...
JavaScript, Groovy, Ruby and Jython
* xref:tools:clustered-rest.adoc[Clustered REST] to retrieve statistical cluster information using REST API
