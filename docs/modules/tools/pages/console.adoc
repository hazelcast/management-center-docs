...
The console is not recommended for production use. If granular access control is critical, consider leaving the console disabled. See xref:{page-latest-supported-hazelcast}@hazelcast:maintain-cluster:monitoring.adoc#managing-console-support[Toggle Console Support] to enable or disable it.
====
