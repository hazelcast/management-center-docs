...
The sidebar navigation item provides notifications about existence members with slow operations. A tooltip displays the total count of members with slow operations.
