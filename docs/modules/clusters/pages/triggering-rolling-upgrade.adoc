...
. Upgrade the codebase of each Hazelcast member. Follow the steps described in the xref:{page-latest-supported-hazelcast}@hazelcast:clusters:triggering-rolling-upgrade[Platform documentation].
