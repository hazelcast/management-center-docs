= Deploying a Client Filter List with the REST API
...
- Enable clustered REST, using the xref:system-properties.adoc#hazelcast-mc-rest-enabled[`hazelcast.mc.rest.enabled`] property.
