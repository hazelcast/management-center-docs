...
* **CP Subsystem:** Shows the xref:{page-latest-supported-hazelcast}@hazelcast:cp-subsystem:cp-subsystem.adoc[CP subsystem]
...
property explained in the xref:{page-latest-supported-hazelcast}@hazelcast:ROOT:system-properties.adoc[System Properties appendix] of
the Hazelcast documentation).
