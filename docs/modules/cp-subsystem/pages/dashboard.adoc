= CP Subsystem
:description: You can use the CP Subsystem section to manage and monitor the CP subsystem in a cluster.

You can use the *CP Subsystem* section to manage and monitor the CP subsystem in a cluster.
